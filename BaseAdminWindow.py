...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidgetChild = QtWidgets.QWidget(MainWindow)
        self.coolerSlider = QtWidgets.QSlider(self.centralwidgetChild)
        ...
        self.label = QtWidgets.QLabel(self.centralwidgetChild)
        self.label.setGeometry(QtCore.QRect(20, 30, 411, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidgetChild)
        self.label_2.setGeometry(QtCore.QRect(20, 100, 47, 13))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.centralwidgetChild)
        self.label_3.setGeometry(QtCore.QRect(410, 100, 47, 13))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.centralwidgetChild)
        self.label_4.setGeometry(QtCore.QRect(20, 150, 411, 21))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_4.setFont(font)
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(self.centralwidgetChild)
        self.label_5.setGeometry(QtCore.QRect(20, 210, 411, 31))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_5.setFont(font)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.centralwidgetChild)
        self.label_6.setGeometry(QtCore.QRect(720, 20, 121, 51))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.label_6.setFont(font)
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(self.centralwidgetChild)
        ...
        self.label_8 = QtWidgets.QLabel(self.centralwidgetChild)
        self.label_8.setGeometry(QtCore.QRect(20, 280, 421, 61))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_8.setFont(font)
        self.label_8.setObjectName("label_8")
        self.label_9 = QtWidgets.QLabel(self.centralwidgetChild)
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(350, 230, 581, 161))
